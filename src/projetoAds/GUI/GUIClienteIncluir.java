 ...
 * @author aluno
 */
public class GUIClienteIncluir extends javax.swing.JFrame {

    /**
     * Creates new form GUICliente
     */
    public GUIClienteIncluir() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIClienteIncluir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIClienteIncluir().setVisible(true);
            }
        });
    }
