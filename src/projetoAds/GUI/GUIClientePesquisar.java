 ...
 * @author aluno
 */
public class GUIClientePesquisar extends javax.swing.JFrame {

    /**
     * Creates new form GUIClientePesquisar
     */
    public GUIClientePesquisar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIClientePesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIClientePesquisar().setVisible(true);
            }
        });
    }
